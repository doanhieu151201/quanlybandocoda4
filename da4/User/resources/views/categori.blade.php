        ...
        <div class="row flex-row-reverse">
          ...
          <div class="col-lg-9">
            <div class="latest_product_inner">
              <div class="row">
                <div class="col-lg-4 col-md-6" dir-paginate="sp in sanphams| filter:timkiem | itemsPerPage: pageSize" current-page="currentPage" >
                ...
                <div class="product-btm">
                  ...
                  <div class="mt-3">
                   <span>Giá: <a >@{{sp.unit_price|number:'0'}}</a>$</span>
